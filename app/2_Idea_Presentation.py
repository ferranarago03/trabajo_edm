...
### Origen de la Idea
El origen de la idea planteada surge de la observación de un problema creciente en las ciudades mediterráneas: la exposición de la población a altas temperaturas durante sus desplazamientos urbanos. A partir de esta problemática y aprovechando la disponibilidad de datos abiertos geoespaciales y meteorológicos, se planteó el desarrollo de una herramienta que, mediante algoritmos de cálculo de rutas y visualización interactiva, proponga trayectos que minimicen la exposición al calor y favorezcan la movilidad sostenible. Este planteamiento se alinea con los objetivos de adaptación al cambio climático en entornos urbanos.
...
- **Consideración de la humedad y otros factores térmicos**: La incorporación de datos relativos a la humedad y a otros indicadores del confort térmico, como la sensación térmica, permitiría ajustar aún más los cálculos de las rutas, priorizando aquellas que minimicen la exposición a condiciones ambientales adversas.
